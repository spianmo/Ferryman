...
import { RouterProvider, createHashHistory, createMemoryHistory } from '@tanstack/react-router'
import './index.css'
...
async function bootstrapCodeAgentStandalone() {
    initializeFontScale()
