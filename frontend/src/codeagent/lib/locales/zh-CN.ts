export default {
  ...
  'newSession.browse': '选择目录',
  'newSession.recent': '最近路径',
  'newSession.remotePath': '远程路径',
  'newSession.remoteRefresh': '刷新',
  'newSession.remoteUp': '上级',
  'newSession.remoteUsePath': '使用当前路径',
  'newSession.remoteLoading': '正在加载目录…',
  'newSession.remoteEmpty': '没有子目录',
  'newSession.dirDialog.title': '选择项目目录',
  'newSession.dirDialog.description': '使用 Ferryman 文件面板同款列表样式选择文件夹。',
  'newSession.dirDialog.go': '前往',
  'newSession.dirDialog.selectCurrent': '使用当前路径',
  'newSession.dirDialog.needMachine': '请先选择机器。',
  'newSession.dirDialog.loadFailed': '远程目录读取失败',
  'newSession.dirDialog.empty': '当前路径下没有子目录',
  'newSession.agent': '代理',
  'newSession.model': '模型',
  ...
  'misc.model': '模型',
  'misc.reasoningEffort': '推理级别',
  'misc.codexFast': '快速模式 (/fast)',
  'misc.codexFastDescription': '同样的模型与智能，优先更快输出。',
  'misc.codexFastOn': '快速模式开',
  'misc.codexFastOff': '快速模式关',
  'misc.reasoningEffort.low': '低',
  'misc.reasoningEffort.medium': '中',
  'misc.reasoningEffort.high': '高',
  'misc.reasoningEffort.xhigh': '超高',
  'misc.loading': '加载中…',
  ...
  'misc.percentLeftWithTokens': '剩余 {percent}%（{used}/{limit} tokens）',
  'misc.online': '在线',
} as const
